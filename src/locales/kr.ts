export const langKR = {
	...
	'calc.editors.ra.toolbar.recursive-assignment': '재귀적 관계',
	'calc.editors.ra.toolbar.recursive-assignment-content[0]': '<b class="math">μ</b> t = S <span class="math">&cup;</span> ( t <b>⨝</b> T )',
	'calc.editors.ra.toolbar.recursive-assignment-content[1]': '<br /><b>mu</b> t = S union ( t join T )',
	'calc.editors.ra.toolbar.recursive-assignment-content[2]': '<br /><b>recursive</b> t = S <span class="math">&cup;</span> ( t ⨝ T )',
